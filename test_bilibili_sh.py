...
task = BilibiliGetAccountTask(client, '/data/data/tv.danmaku.bili', 'app_account', 'abdSh.sh', "/sdcard/adbAccountTest",
                              'AccountData', 'app_account')  # 创建任务
# client.set_task(task)  # 设置任务
# client.run_current_task()  # 开始运行任务
task2 = BilibiliTranAccountTask(client,'/data/data/tv.danmaku.bili', 'Datas', 'abdTransSh.sh', "/sdcard/adbAccountTest",
